    ...
    <footer className="bg-ink text-paper pt-32 pb-12">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="mt-8 text-white/20 text-[10px] leading-relaxed max-w-2xl">
          <p>LedgerCFO is a provider of back-office services, including bookkeeping, controller services, and CFO services.</p>
          <p className="mt-2">LedgerCFO is not a public accounting firm and does not provide services that would require a license to practice public accountancy.</p>
        </div>
      </div>
    </footer>
  );
